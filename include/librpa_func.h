...
#define LIBRPA_C_H_FUNC_WRAP_WOPT(ret, func, ...) ret func(LibrpaHandler *h, const LibrpaOptions *p_opts, __VA_ARGS__)
#define LIBRPA_C_H_FUNC_WRAP_WOPT_NOPAR(ret, func) ret func(LibrpaHandler *h, const LibrpaOptions *p_opts)
