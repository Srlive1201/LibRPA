...
void Cal_Periodic_Chi0::chi0_main(const char* Input_ngrid) 
{
    ...
    //double first_tau=time_grid.begin()->first;
    // for(int I=0;I!=natom;I++)
    //     for(int J=0;J!=natom;J++)
    //     {
    //         cout<<"Green_atom  IJ:  "<<I<<"  "<<J<<endl;
    //         print_matrix("Green-atom",Green_atom[0][I][J][first_tau][{0,0,0}]);
    //     }
                ...
                for(auto &Q_p:J_p.second)
                {
                    ...
                    for(auto &I_p:Vq)
                    {
                       ...
                       // cout<<"         pi_IQ: "<<pi_k.at(freq).at(ik_vec).at(I).at(Q)(0,0)<<"   pi_IJ: "<<pi_k.at(freq).at(ik_vec).at(I).at(J)(0,0);
                        if(I<=J)
                        {
                           // cout<<"   1"<<"  Vq: "<<(*Vq.at(I).at(J).at(ik_vec))(0,0)<<endl;
                        ...
                        {
                           // cout<<"   2"<<"  Vq: "<<transpose(*Vq.at(J).at(I).at(ik_vec),1)(0,0)<<endl;
                        ...
                        if(J!=Q)
                        {
                            ...
                            if(I<=Q)
                            {
                               // cout<<"   3"<<"  Vq: "<<(*Vq.at(I).at(Q).at(ik_vec))(0,0)<<endl;
                                pi_k.at(freq).at(ik_vec).at(I).at(J)+=(*Vq.at(I).at(Q).at(ik_vec))*chi0_QJ;
                            }
                            else
                            {
                               // cout<<"   4"<<"  Vq: "<<transpose(*Vq.at(J).at(I).at(ik_vec),1)(0,0)<<endl;
