...
static void finalize(bool success)
{
    ...
    librpa_int::global::profiler.stop("total");
...
int main(int argc, char **argv)
{
     ...
     */
    librpa_int::global::profiler.start("driver_read_params", "Driver Read Input Parameters");
    ...
    mpi_comm_global_h.barrier();
    librpa_int::global::profiler.stop("driver_read_params");

    librpa_int::global::profiler.start("driver_band_out", "Driver Read Meanfield band");
    ...
    librpa_int::global::profiler.stop("driver_band_out");
    ...
    librpa_int::global::profiler.start("driver_read_common_input_data", "Driver Read Task-Common Input Data");
    ...
    librpa_int::global::profiler.start("driver_read_eigenvector");
    ...
    librpa_int::global::profiler.stop("driver_read_eigenvector");
    ...
    librpa_int::global::profiler.start("driver_read_Cs_Vq");
    ...
    if(parallel_routing == ParallelRouting::ATOM_PAIR)
    {
        ...
        librpa_int::global::profiler.start("driver_read_Cs");
        read_Cs(driver_params.input_dir, Params::cs_threshold,local_atpair);
        librpa_int::global::profiler.stop("driver_read_Cs");
    ...
    librpa_int::global::profiler.stop("driver_read_Cs_Vq");
    ...
    // std::flush(ofs_myid);
    // mpi_comm_global_h.barrier();
    librpa_int::global::profiler.stop("driver_read_common_input_data");
    ...
    if (librpa_int::global::mpi_comm_intra_h.myid == 0)
    {
        ...
        {
            const auto cputime = librpa_int::global::profiler.get_cpu_time_last("driver_read_common_input_data") / 60.0;
            const auto walltime = librpa_int::global::profiler.get_wall_time_last("driver_read_common_input_data") / 60.0;
