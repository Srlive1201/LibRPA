...
cplxdb compute_pi_det_blacs(ComplexMatrix &loc_piT, const LIBRPA::ArrayDesc& arrdesc_pi, int *ipiv, int &info);

cplxdb compute_pi_det_blacs_2d(Matz &loc_piT, const LIBRPA::ArrayDesc &arrdesc_pi, int *ipiv, int &info);
double compute_pi_det_blacs_2d_gamma_only(matrix_m<double> &loc_piT, const LIBRPA::ArrayDesc &arrdesc_pi, int *ipiv, int &info);
