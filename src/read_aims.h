...
void READ_AIMS_Vq(const string &dir_path, const string &vq_fprefix, double threshold, atpair_k_cplx_mat_t &coulomb);
void handle_Cs_file(const std::string &file_path, double threshold);
